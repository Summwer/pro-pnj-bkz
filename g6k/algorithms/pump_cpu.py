...
def wrapped_sieve(pump):
    if pump.phase == "init" or  pump.g6k.n < 50:
        alg = "gauss"
    else:
        # if pump.g6k.n < 70 and pump.g6k.n >= 50:
...
def pump(g6k, tracer, kappa, blocksize, dim4free, down_sieve=False, down_sat=None, # Main parameters
    ...
    with tracer.context(("pump", "beta:%d f:%d" % (blocksize, dim4free))):
        with g6k.temp_params(reserved_n=pump.r-pump.l):
            ...
            # Pump Down
            pump.phase = "down"
            #print("print( kappa+down_stop) = %d" %(kappa+down_stop))
