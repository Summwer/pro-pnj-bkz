...
void sim_strategy(Params params, vector<double> l, vector<tuple<int,int,int>> strategy, double sigma){
    ...
    for(int i = 0; i<int(strategy.size()); i++){
        ...
        for(int t = 0; t< tours; t++){
            ...
            // vector<double> l_;
            // this->sim -> simulate(l2,l,beta,1,1);
...
int main(){
    ...
    n = 40, alpha = 0.025;
    strategy = {{50,4,1},{51,1,1},{52,1,1},{53,1,1},{54,1,1},{55,1,1},{56,1,1},{57,1,1},{58,1,1},{59,1,1},{60,1,1},{61,1,1},{62,1,1},{63,1,1},{64,1,1},{65,1,1},{66,1,1},{67,1,1},{68,1,1},{69,1,1},{70,1,1},{71,1,1},{72,1,1},{73,1,1},{74,1,1},{75,1,1},{76,1,1},{77,1,1},{78,1,1},{87,4,1},{92,4,1},{98,4,1}};
    params.list_decoding = "agps20";
    ...
    n = 80, alpha = 0.005;
    strategy = {{50,4,1},{51,1,1},{52,1,1},{53,1,1},{54,1,1},{55,1,1},{56,1,1},{57,1,1},{58,1,1},{59,1,1},{60,1,1},{61,1,1},{62,1,1},{63,1,1},{64,1,1},{65,1,1},{66,1,1},{67,1,1},{78,1,5},{85,4,1},{88,4,1},{89,4,1},{97,4,2},{100,4,1},{103,4,1},{107,4,1},{111,4,1}};
    params.list_decoding = "agps20";
    printf("n = %d, alpha = %1.3f, list_decoding = agps20\n", n, alpha);
    test_lwechal_from_original_instance(params, n, alpha, strategy);
