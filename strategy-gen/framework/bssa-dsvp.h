...
class BSSA{
    public:
        ...
        BSSA::blocksize_strategy min_tour_to_each_goal_beta(BSSA::blocksize_strategy bs, int beta, int jump, pair<int,double> goal_quality); //Find the minial tours for a pnj-BKZ-beta-J to reach a basis quality of goal_dsvp.
        ...
        pair<int,double> max_tour_for_pnjbkz_beta(BSSA::blocksize_strategy bs, int beta); //maximal tours for one pnj-bkz-beta to reduce the basis.
        pair<int,double> max_tour_for_pnjbkz_beta(vector<double> l, int beta);
